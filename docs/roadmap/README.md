...
| 2 | [Interlúdio 2c](02c-interludio.md) — deploys mortos, cliente com fingerprint, sessão que expira em uso, `repo-worker` para fora | vssh-sso + `vssh-repo` | 🟡 itens 1 a 7 feitos · −11260 linhas no portal, 107 requisições por carga viraram 0, a sessão parou de expirar em uso, e o Worker virou repositório próprio |
