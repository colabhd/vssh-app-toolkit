...
| 2 | [Interlúdio 2c](02c-interludio.md) — deploys mortos, cliente com fingerprint, sessão que expira em uso, `repo-worker` para fora | vssh-sso + 1 repo novo | 🟡 itens 1 a 4 feitos · −6460 linhas, 107 requisições por carga viraram 0, e a sessão parou de expirar em uso |
